...
$(document).on("ready", function () {
  ...
  var owl = $(
    ".header-slider,.owl-demo,.owl-demo1,.testimonial15-row, .corporate-header-slider"
  );
  owl.owlCarousel({
    autoPlay: 4000,
  ...
  var owl = $(
    ".testimonial2,.testimonial3,.testimonial5,.testimonial7-row,.testimonial11-row,.testimonial13"
  );
